...
import 'package:movie_app_api/model/castList.dart';
...
import 'package:movie_app_api/model/movieImage.dart';
...
class ApiService {
  ...
  final String apiKey = 'api_key=c5cbf38f66921c68238752f392e028a9';
  ...
  Future<MovieDetail> getMovieDetail(int movieId) async {
    try {
      ...
      print(movieDetail.trailerId +" is youtube url");
  ...
  Future<String> getYoutubeId(int id) async {
    try {
      ...
      print(youtubeId.toString()+' is youtube');
      return youtubeId;
    } catch (error, stacktrace) {
      throw Exception(
          'Exception accoured: $error with stacktrace: $stacktrace');
